...
echo -e "\n\n******** STARTING ROBOT DAVE for EKF TEST ********"
...
echo -e "\n*** Start ROS2 GoPiGo3 node - remap /odom to /wheel/odometry"
echo "*** ros2 run ros2_gopigo3_node gopigo3_node --ros-args -p S1LPW:=2094 -p S1RPW:=750 -p S1SECTOR:=2.443 &"
ros2 run ros2_gopigo3_node gopigo3_node --ros-args -p S1LPW:=2094 -p S1RPW:=750 -p S1SECTOR:=2.443 -r /odom:=/wheel/odometry &
...
echo -e "\n*** Start GoPiGo3 IMU sensor node - remap /imu_sensor/imu to /imu/data"
echo "*** ros2 run ros2_gopigo3_node imu_sensor &"
ros2 run ros2_gopigo3_node imu_sensor -r /imu_sensor/imu:=/imu/data &
...
echo -e "\n*********DONE start_robot_dave_ekf.sh DONE *******\n"
