...
static const _MotorStatusLR_type_support_symbol_names_t _MotorStatusLR_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_gopigo3_msg, msg, MotorStatusLR)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_gopigo3_msg, msg, MotorStatusLR)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_gopigo3_msg, msg, MotorStatusLR)() {
  return &::ros2_gopigo3_msg::msg::rosidl_typesupport_c::MotorStatusLR_message_type_support_handle;
}
