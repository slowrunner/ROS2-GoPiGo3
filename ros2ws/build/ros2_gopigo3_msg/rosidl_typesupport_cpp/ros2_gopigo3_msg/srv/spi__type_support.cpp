...
static const _SPI_Request_type_support_symbol_names_t _SPI_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_gopigo3_msg, srv, SPI_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_gopigo3_msg, srv, SPI_Request)),
  }
};
...
{
  return &::ros2_gopigo3_msg::srv::rosidl_typesupport_cpp::SPI_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_gopigo3_msg, srv, SPI_Request)() {
  return get_message_type_support_handle<ros2_gopigo3_msg::srv::SPI_Request>();
}
...
static const _SPI_Response_type_support_symbol_names_t _SPI_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_gopigo3_msg, srv, SPI_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_gopigo3_msg, srv, SPI_Response)),
  }
};
...
{
  return &::ros2_gopigo3_msg::srv::rosidl_typesupport_cpp::SPI_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_gopigo3_msg, srv, SPI_Response)() {
  return get_message_type_support_handle<ros2_gopigo3_msg::srv::SPI_Response>();
}
...
static const _SPI_type_support_symbol_names_t _SPI_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_gopigo3_msg, srv, SPI)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_gopigo3_msg, srv, SPI)),
  }
};
...
{
  return &::ros2_gopigo3_msg::srv::rosidl_typesupport_cpp::SPI_service_type_support_handle;
}
