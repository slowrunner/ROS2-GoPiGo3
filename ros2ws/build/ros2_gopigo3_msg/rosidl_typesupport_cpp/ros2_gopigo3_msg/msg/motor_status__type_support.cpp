...
static const _MotorStatus_type_support_symbol_names_t _MotorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_gopigo3_msg, msg, MotorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_gopigo3_msg, msg, MotorStatus)),
  }
};
...
{
  return &::ros2_gopigo3_msg::msg::rosidl_typesupport_cpp::MotorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_gopigo3_msg, msg, MotorStatus)() {
  return get_message_type_support_handle<ros2_gopigo3_msg::msg::MotorStatus>();
}
